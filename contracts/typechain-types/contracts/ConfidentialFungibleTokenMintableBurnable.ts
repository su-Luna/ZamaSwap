...
export interface ConfidentialFungibleTokenMintableBurnableInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
  ...
  encodeFunctionData(
    functionFragment: "swapConfidentialForConfidential",
    values: [AddressLike, AddressLike, BytesLike, BytesLike]
  ): string;
...
export interface ConfidentialFungibleTokenMintableBurnable
  ...
  interface: ConfidentialFungibleTokenMintableBurnableInterface;
  ...
  burn: TypedContractMethod<
    [from: AddressLike, amount: BytesLike, inputProof: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, amount: BytesLike, inputProof: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  swapConfidentialForConfidential: TypedContractMethod<
    [
      fromToken: AddressLike,
      toToken: AddressLike,
      amountInput: BytesLike,
      inputProof: BytesLike
    ],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "swapConfidentialForConfidential"
  ): TypedContractMethod<
    [
      fromToken: AddressLike,
      toToken: AddressLike,
